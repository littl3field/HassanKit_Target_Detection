...
### UPDATE: Add all directory path URLs containing http://url.com/filename.txt to urls.txt
### UPDATE:I have since removed this opendir for obfuscation & TLP reasons*
